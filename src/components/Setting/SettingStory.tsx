            ...
            <div className="max-w-[900px] mx-auto px-3 py-5">
                ...
                <div className="flex flex-col w-full">
                    <div className="pb-1 font-bold">Headline</div>
                        <input type="text" value={data.headline} onChange={changeHeadline} className="w-full py-2 px-3 focus:outline-none border-[1px] border-slate-200" placeholder="Enter a headline" />
                    </div>
                    <div className="flex flex-col w-full pt-6">
                        <div className="pb-1 font-bold">Story</div>
                        <textarea value={data.description} onChange={changeDesc} className="w-full h-[150px] py-2 px-3 focus:outline-none border-[1px] border-slate-200" placeholder="Enter a description..." />
                    </div>
                </div>
            </div>
        </div>
