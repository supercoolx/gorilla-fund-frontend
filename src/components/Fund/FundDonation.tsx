        ...
        <div className="p-3 max-w-[500px] text-gray-500 text-sm">
            <div className="">
                ...
                <div className="flex justify-between py-3">
                    ...
                    <button className="border-[1px] border-teal-700 text-teal-700 px-5 rounded-full">Contact</button>
                </div>
            </div>
            <hr className="my-3" />
            <div className="flex flex-col gap-5">
                <div className="flex items-end justify-between pt-2">
                    ...
                    <div className="text-teal-700">See all</div>
                </div>
                <div className="flex gap-3">
                    <img src={imgAvatar} className="h-10 rounded-full" alt="" />
                ...
                <hr />
                <div className="pl-12">
                    <button className="py-2 px-4 border-[1px] border-teal-700 text-teal-700 rounded-full">Load more</button>
                </div>
            </div>
        </div>
    )
